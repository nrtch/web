...
import { platform } from 'helpers/utils';
  ...
  <Section>
    <Row stretch>
      ...
      <Column>
        ...
        <Text short>
          Мы работаем открыто и честно. Вся торговая история NEXX, а также
          текущие открытые сделки доступны в нашем официальном приложении.
        </Text>
        <Buttons>
